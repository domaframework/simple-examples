...
VALUES(/*order.orderId*/1, /*order.username*/'username', /*order.orderDate*/'2001-01-01', /*order.shipAddress1*/'shipAddress1', /*order.shipAddress2*/'shipAddress2', /*order.shipCity*/'shipCity',
