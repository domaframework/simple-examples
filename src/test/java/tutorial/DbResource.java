...
public class DbResource extends ExternalResource {
    ...
    protected void before() throws Throwable {
        try (Connection connection = AppConfig.singleton()
                .getOriginalDataSource().getConnection()) {
            try (Statement statement = connection.createStatement()) {
                statement
                        .execute("create sequence employee_seq start with 100 increment by 1");
                statement
                ...
                statement.execute("insert into department values(3,'SALES',1)");
                statement
